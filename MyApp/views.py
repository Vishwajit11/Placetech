...
from .models import Stuprnno
from .models import Tpocred
...
def postjd(request):
    return render(request,"postjd.html")
...
#             # Collect project data from the form
...
def create_resume(request):
    ...
    if request.method=="POST":
        ...
        if request.POST.get("fname",""):
            ...
            obj.project_title1=request.POST.get("project_title1","")
            obj.project_tech1=request.POST.get("project_tech1","")
            obj.project_description1=request.POST.get("project_description1","")

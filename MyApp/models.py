...
class Resume(models.Model):
    ...
    project_title1 = models.CharField(max_length=100, default="YourDefaultHere")
    project_tech1 = models.CharField(max_length=100, default="YourDefaultHere")
    project_description1 = models.TextField(max_length=1000, default="YourDefaultHere")
